...
instance = nova.servers.create(name="GROUP-12-VM-"+str(identifier), image=image, flavor=flavor, key_name='olzmanskeyz',userdata=userdata, nics=nics,security_groups=secgroups)
