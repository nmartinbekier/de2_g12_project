...
server_name = "group_12_server_"+str(random.randint(1000,9999))
flavor = "ssc.medium" 
...
instance = nova.servers.create(name=server_name, image=image, flavor=flavor, key_name='olzmanskeyz',userdata=userdata, nics=nics, security_groups=secgroups)
